...
export default function EmployeeSidebar() {
  ...
  const links = [
    ...
    { name: 'Attendance', href: '/employee/attendance', icon: Clock3 },
    { name: 'Timesheet', href: '/employee/timesheet', icon: ClipboardList },
  ...
  return (
    <aside className="w-64 min-h-screen bg-[#0d0a21] border-r border-white/5 text-slate-100 flex flex-col relative z-25">
      <div className="p-6 border-b border-white/5 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight text-white">HRMS</h1>
          <p className="text-[10px] text-cyan-400 uppercase tracking-widest font-semibold mt-0.5">
            Employee Portal
          </p>
        </div>
      </div>
