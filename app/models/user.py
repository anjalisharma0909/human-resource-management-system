# from sqlalchemy import Column, Integer, String, Date, Time, ForeignKey, TIMESTAMP, text, Boolean, Numeric
...
#     work_duration = Column(String(20))
#     status = Column(String(20), nullable=False, default="ON-TIME")
